...
function setTable(array){
    ...
    for (let i = 0; i < array.length; i++) {
        ...
        row.insertCell(0).innerHTML = pokemon.num;
        row.insertCell(1).innerHTML = pokemon.name;
        row.insertCell(2).innerHTML = pokemon.type;
        row.insertCell(3).innerHTML = pokemon.height;
        row.insertCell(4).innerHTML = pokemon.weight;
    }
}
...
function sortById() {
  const sorted = pokemons.sort(function (current, next) {
    a = current.id;
    b = next.id;
    if (a > b) return 1;
    else return -1;
...
function sortByName() {
  ...
  function sortByHeight() {
    const sorted = pokemons.sort(function (current, next) {
      a = Number.parseFloat(current.height.replace(' m', ''));
      b = Number.parseFloat(next.height.replace(' m', ''));
      if (a > b) return 1;
      else return -1;
    });
    setTable(sorted);
  ...
  function sortByWeight() {
    const sorted = pokemons.sort(function (current, next) {
      a = Number.parseFloat(current.weight.replace(' m', ''));
      b = Number.parseFloat(next.weight.replace(' kg', ''));
      if (a > b) return 1;
      else return -1;
    });
    setTable(sorted);
